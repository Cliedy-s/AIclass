...
CREATE TABLE `member` (
  ...
  KEY `IX_member_userPhone_userEmail` (`userPhone`,`userEmail`)
...
INSERT INTO `member` VALUES ('test01','홍길동','010-1111-2222','F',NULL,NULL);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `member_BEFORE_DELETE` BEFORE DELETE ON `member` FOR EACH ROW BEGIN
	insert into deleted_member(userID, userName, userPhone) values(old.userid, old.userName, old.userPhone);
END */;;
DELIMITER ;
