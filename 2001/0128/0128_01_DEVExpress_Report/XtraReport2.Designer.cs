namespace _0128_01_DEVExpress_Report
{
    partial class XtraReport2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dsOrder1 = new _0128_01_DEVExpress_Report.DSOrder();
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[Query].[QuantityPerUnit]")});
            ...
            customSqlQuery1.Sql = "SELECT Right(\'00000\' + cast([BarcodeID] as varchar), \'5\') BarcodeId, ProductName," +
    " QuantityPerUnit, Qty\r\nfrom BarcodeOutput bo, Products p\r\nwhere bo.ProductID = p" +
