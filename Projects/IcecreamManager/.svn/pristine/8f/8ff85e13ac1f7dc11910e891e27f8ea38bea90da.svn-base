...
,(3, 3000, '우유', 1500, 100000, 10000)
,(3, 3000, '생크림', 1500, 100000, 10000)
,(3, 3000, '바닐라익스트랙 ', 1500, 550, 500)
,(3, 3000, '설탕', 1500, 100000, 10000)
,(3, 3000, '크림치즈', 1500, 800, 500)
,(3, 3000, '플레인 요거트', 1500, 800, 500)

,(3, 3001, '체리', 1500, 500, 50)
,(3, 3001, '체리시럽', 1500, 550, 550)
,(3, 3001, '붉은 식용 색소', 1500, 600, 500)

,(3, 3003, '녹차파우더', 1500, 10000, 1000)

,(3, 3003, '계란 노른자', 1500, 800, 500)
...
insert into BOM (mat_ParentNo, mat_ChildNo, bom_ChildEach)
values
(2006, 2000, 1),
(2007, 2000, 1),
(2008, 2000, 1),
