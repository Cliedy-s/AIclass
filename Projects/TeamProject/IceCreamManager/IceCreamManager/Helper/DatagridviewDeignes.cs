...
{
    public class DatagridviewDeignes
    {
      ...
      string dataPropertyName, bool visibility, int colWidth = 100, DataGridViewContentAlignment textAlign = DataGridViewContentAlignment.MiddleLeft)
        {
            ...
            dgv.AlternatingRowsDefaultCellStyle.BackColor = Color.Beige;//홀수행 색변경
            dgv.RowHeadersDefaultCellStyle.BackColor = Color.FromArgb(255, 224, 192);   //컬럼 해더 색설정     
            dgv.DefaultCellStyle.SelectionBackColor = Color.FromArgb(255, 192, 128); //컬럼색설정
