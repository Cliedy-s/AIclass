...
namespace PhoneBook6
{
    public class PhoneBookManager
    {
        ...
        readonly string filepath = Environment.CurrentDirectory + @"\PhoneBook.dat";
        static PhoneBookManager inst = null;

        internal HashSet<PhoneInfo> InfoStorage { get => infoStorage; set => infoStorage = value; }
        ...
        private PhoneBookManager() { loadData(); }
        ...
        public void saveDate()
        {
            ...
            using (Stream ws = new FileStream(filepath, FileMode.Create))
            {
                ...
                serializer.Serialize(ws, this.InfoStorage);
            }
        }
