...
namespace PhoneBook7
{
    public class PhoneBookManager
    {
        ...
        public void storeToFile()
        {
            try
            {
                Stream ws = new FileStream(dataFile, FileMode.Create);
        ...
        public void readFromFile()
        {
            ...
            try
            {
                Stream rs = new FileStream(dataFile, FileMode.Open);
                BinaryFormatter deserializer = new BinaryFormatter();

                infoStorage.Clear();

                infoStorage = (HashSet<PhoneInfo>)deserializer.Deserialize(rs);
                rs.Close();
            }
            catch (IOException err)
            {
